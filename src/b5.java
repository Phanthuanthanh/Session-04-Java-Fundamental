...
public class b5 {
    ...
    public static void main(String[] args) {
        ...
        String[] logs = {
                "2024-05-20 | User: PhanThuanThanh | Action: BORROW | BookID: BK12345",
                "2024-05-21 | User: NguyenDinhSon | Action: RETURN | BookID: BK12345",
                "2024-05-22 | User: NguyenDucAnh | Action: BORROW | BookID: BK67890"
        };

        String regex =
                "(\\d{4}-\\d{2}-\\d{2}) \\| User: (\\w+) \\| Action: (\\w+) \\| BookID: (\\w+)";
